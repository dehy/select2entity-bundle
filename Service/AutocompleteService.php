...
namespace Dehy\ChoicesJsEntityBundle\Service;
...
class AutocompleteService
{
    ...
    public function getAutocompleteResults(Request $request, $type)
    {
        ...
        $result['results'] = array_map(function ($item) use (
            $accessor,
            $fieldOptions
        ) {
            return [
                'id' => $accessor->getValue(
                    $item,
                    $fieldOptions['primary_key']
                ),
